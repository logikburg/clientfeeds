...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $ionicFilterBar, $ionicSideMenuDelegate, NotifyDataService) {
...
.controller('NotificationsCtrl', function($scope, $http, $timeout, $templateCache, $cordovaNetwork, NotifyDataService) {
  ...
  promise.success(function(data, status, headers, config) {
    ...
    if (data.data != null && data.data.hasOwnProperty('length')) {
      NotifyDataService.setNewNotifications(data.data.length);
